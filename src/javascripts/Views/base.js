...
ngapp.controller('baseController', function($scope, $rootScope, $document, $q, protocolService, settingsService, themeService, buttonFactory, modalService, hotkeyService, contextMenuService) {
    // helper variables
