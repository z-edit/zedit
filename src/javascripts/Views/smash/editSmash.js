ngapp.config(['$stateProvider', function ($stateProvider) {
    $stateProvider.state('base.editSmash', {
        templateUrl: 'partials/editSmash.html',
        controller: 'editSmashController',
        url: '/edit_smash'
    });
}]);

ngapp.controller('editSmashController', function($scope, $timeout, progressService, hotkeyService, smashService, eventService, layoutService) {
    // helper functions
