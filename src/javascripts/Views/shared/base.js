...
ngapp.controller('baseController', function($scope, $rootScope, $q, $timeout, protocolInterface, settingsService, themeInterface, buttonService, modalInterface, hotkeyInterface, rootContextMenuInterface, eventService) {
    // helper variables
